...
class CAModel(tf.keras.Model):
    ...
    def __init__(self, NO_NEIGHBORS, NO_CHANNELS, NO_CLASSES, H, W, add_noise=True, model_complexity='simplest'):
        super().__init__()
...
def get_model(folder, id_run, i, NO_NEIGHBORS, NO_CHANNELS, NO_CLASSES, H, W, ADD_NOISE, model_complexity):
    '''
    Gets the models parameters
    '''
    ca = CAModel(NO_NEIGHBORS, NO_CHANNELS, NO_CLASSES, H, W, add_noise=ADD_NOISE, model_complexity=model_complexity)
